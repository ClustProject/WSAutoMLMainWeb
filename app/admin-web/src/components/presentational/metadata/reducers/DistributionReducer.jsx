...
export default function DistributionReducer(state, action) {
  ...
  if (type === "data-ex-79") {
    return {
      description: "VDS_ID, 지점이정, VDS존시작이정, VDS존종료이정, 노선번호, VDS존유형구 분코드, 노선구성순번, 기점종점방향구분코드, VDS존길이, 도로등급구분코드, 콘존ID",
      temporalResolution: "1일",
      accurualPeriodicity: "1일",
      spatial: "전국",
  ...
  if (type === "data-ex-78") {
    return {
      description: "콘존ID, 콘존길이, 기점종점방향구분코드, 시작노드ID, 종료노드ID, 차로수, 노 선번호, 제한속도, 노선구성순번, 콘존명, 버스전용차로유무, 도로등급구분코드",
      temporalResolution: "1일",
      accurualPeriodicity: "1일",
      spatial: "전국",
      temporal: "2021.01.01"
