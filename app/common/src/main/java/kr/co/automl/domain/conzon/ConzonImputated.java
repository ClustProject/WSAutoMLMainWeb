...
import kr.co.automl.domain.conzon.dto.ConzonImputatedResponse;
...
public class ConzonImputated {
    ...
    @Builder
    private ConzonImputated(Long id, String conzonId, String conzonName, LocalDateTime conzonDate, String conzonData) {
        this.id = id;
     ...
     * @return 변환된 응답 객체
     */
    public ConzonImputatedResponse toResponse() {
        return ConzonImputatedResponse.builder()
                .id(this.id)
