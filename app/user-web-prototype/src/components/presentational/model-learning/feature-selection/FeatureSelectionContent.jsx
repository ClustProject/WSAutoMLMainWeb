...
import { getFeatureSelectionContent } from "../../../../api/api.js";
...
const FeatureSelectionContent = (props) => {
  ...
  useEffect(() => {
    getFeatureSelectionContent().then((_content) => setContent(_content));
  }, []);
  ...
  return (
    <Box>
      ...
      >
        데이터 정제 ( 제거된 결측치 : {content.removed_missing_value_count},
